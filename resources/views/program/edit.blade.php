<x-app>
    ...
    <div class="card shadow-lg p-3">
        <form action="{{ route('program.update', $program) }}" method="post" class="form">
            @csrf
            @method('put')
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="year" name="year" value="{{ old('year', $program->year) }}" min="2000" max="2100" required>
            </div>
            ...
            <div class="mb-3">
                ...
                @if($isKoordinator)
                    ...
                    <input type="text" class="form-control bg-light" value="{{ $program->division->name ?? '' }}" readonly>
                    <!-- Walau readonly, kita biarkan kosong name-nya, karena akan ditimpa di controller dengan merge() -->
                    <input type="hidden" name="division_id" value="{{ $program->division_id }}">
                @else
